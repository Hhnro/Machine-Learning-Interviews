...
- Logistic regression ([code](Plain/logistic_regression.ipynb)) :white_check_mark:
  
- K-means clustering ([code](Plain/k_means.ipynb)) :white_check_mark:

- K-nearest neighbors ([code 1](Plain/knn.ipynb) - [code 2](https://github.com/MahanFathi/CS231/blob/master/assignment1/cs231n/classifiers/k_nearest_neighbor.py)) :white_check_mark:
  
- Decision trees ([code](Plain/decision_tree.ipynb)) :white_check_mark:
  <!-- (https://github.com/random-forests/tutorials/blob/master/decision_tree.py) -->

- Linear SVM ([code](Plain/svm.ipynb))
<!-- [link](https://towardsdatascience.com/support-vector-machine-introduction-to-machine-learning-algorithms-934a444fca47)) -->

* Neural networks 
  - Perceptron ([code](Plain/perceptron.ipynb)) 
  - FeedForward NN ([code](Plain/feedforward.ipynb))
  ...
  - Convolution ([code](Plain/convolution.ipynb))
  - CNN 
  - RNN 
